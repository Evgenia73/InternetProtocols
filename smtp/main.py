...
def parse(args):
    ...
    parser.add_argument('--subject', action='store', default='Happy Pictures', help='Set email subject')
...
class Server:
    def __init__(self, host, port, sender, receiver, message_body, subject, secure=False, auth=False,
        ...
        self.subject = f'=?UTF-8?B?{base64_encode(subject.encode("utf8")).decode("utf8")}?='
    ...
    def _auth(self):
        func = lambda log, pas: b'AUTH PLAIN ' + base64_encode(f'\0{log}\0{pas}')
